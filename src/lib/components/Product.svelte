...
>
  ...
  <Dialog.Content class='max-h-[calc(100vh-6rem)] max-w-[calc(100vw-2rem)] rounded-xl overflow-auto grid grid-cols-1 md:grid-cols-[3fr_2fr] lg:max-w-4xl prose prose-h2:font-playfair prose-h2:mt-0 prose-h2:mb-0 prose-h3:mt-0 prose-h3:mb-0 prose-h3:font-playfair '>
    <div>
