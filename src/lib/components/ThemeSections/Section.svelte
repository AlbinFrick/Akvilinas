<script lang="ts">
	...
	let { id, class: className = undefined, divider = undefined, children }: Props = $props();
</script>
...
<style>
	...
	.custom-shape-divider-bottom-1725664064 {
		position: absolute;
		bottom: 0;
		left: 0;
		width: 100%;
	...
	.custom-shape-divider-bottom-1725664064 svg {
		position: relative;
		display: block;
