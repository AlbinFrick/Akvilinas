...
<div class="mt-8 flex w-full flex-col gap-6 px-6 md:flex-row-reverse">
	<div class="mt-6 snap-y">
		...
		<Text>
			Mitt namn är Hilda och det är jag som driver Akvilinas Fika. Akvilinas Fika är en tårtstudio i
			centrala Lycksele. Vi skapar skräddarsydda tematårtor till alla tillfällen.
		</Text>
		...
		<Text>
			Under en lång tid har jag drömt om något eget, så under min mammaledighet hösten 2023 startade
			jag äntligen upp Akvilinas Fika.
		</Text>
		<Divider class="my-3 w-12 md:my-4" />
